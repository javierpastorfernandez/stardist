    ...
    def prepare_for_training(self, optimizer=None):
        ...
        if self.basedir is not None:
            ...
            if self.config.train_tensorboard:
                ...
                self.callbacks.append(CARETensorBoard(log_dir=str(self.logdir), update_freq='batch', prefix_with_timestamp=False, n_images=5, write_images=True, prob_out=False))
